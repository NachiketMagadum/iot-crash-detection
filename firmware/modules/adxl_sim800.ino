...
const int RXPin = 10; // Connect SIM800C TX pin to ESP8266 RX pin D5
const int TXPin = 9;  // Connect SIM800C RX pin to ESP8266 TX pin D4
...
void SendMessage() {
  ...
  delay(100);
  sim800Serial.println("AT+CMGS=\"<YOUR_PHONE_NUMBER>\""); // Set the recipient phone number
  delay(100);
  sim800Serial.println("EMERGENCY ALERT MESSAGE");
  delay(100);
  sim800Serial.println("Vehicle Owner -<OWNER>");
  delay(100);
  sim800Serial.println("Vehicle Number-<PLATE>");
  delay(100);
